...
const PrivacyEdit = () => {
    ...
    async function saveTerms() {
        ...
        const response = await axios.post(postURL, { data: terms, type: 'privacy' });
        if (response.data.success) {
            sessionStorage.setItem('privacy', terms);
    ...
    return (
        <div>
            <div className='flex flex-row'>
                <h1 className='text-black font-black text-3xl p-4'>{t("Privacy")}</h1>
            ...
            <div className="textarea-container">
                <textarea
                    placeholder={t('Write your privacy here in HTML format')}
