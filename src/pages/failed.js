        ...
        <div className='h-screen flex flex-col'>
            ...
            <div className='dark:bg-black flex-1'>
                <div className='flex-1 flex flex-col items-center justify-center py-8'>
                    <p className='text-center font-black text-4xl text-black dark:text-white'>{t("Payment Failed")}</p>
                    <p className='text-center font-normal text-black py-4 dark:text-white'>{t("Your payment failed You can start the payment process again")}</p>
