            ...
            <div className='dark:bg-black flex-1'>
                <div className='flex-1 flex items-center justify-center py-10'>
                    <form onSubmit={contactSubmit} className="max-w-sm m-auto py-4 no-scrollbar">
                        <p className='text-center font-black text-4xl text-black dark:text-white'>{t("Contact")}</p>
                        <p className='text-center font-normal text-black py-4 dark:text-white'>{t("Enter your details and ask your query")}</p>
                        <div className='py-6'>
                            <div className='mb-6 flex flex-row max-md:flex-col md:space-x-3 max-md:space-y-3'>
                                <div>
                                    <div className="mb-2 block">
                                        <Label className="font-bold text-black dark:text-white" htmlFor="name1" value={t("First Name")} />
                                    </div>
                                ...
                                <div>
                                    <div className="mb-2 block">
                                        <Label className="font-bold text-black dark:text-white" htmlFor="name2" value={t("Last Name")} />
                                    </div>
                            ...
                            <div className='mb-6 flex flex-row max-md:flex-col md:space-x-3 max-md:space-y-3'>
                                ...
                                <div>
                                    <div className="mb-2 block">
                                        <Label className="font-bold text-black dark:text-white" htmlFor="phone1" value={t("Phone")} />
                                    </div>
                            ...
                            <div className='mb-6'>
                                <div className="mb-2 block">
                                    <Label className="font-bold text-black dark:text-white" htmlFor="msg1" value={t("Message")} />
                                </div>
                            ...
                            <Button type='submit' isProcessing={processing} processingSpinner={<AiOutlineLoading className="h-6 w-6 animate-spin" />} className='my-2 items-center justify-center text-center dark:bg-white dark:text-black bg-black text-white font-bold rounded-none w-full enabled:hover:bg-black enabled:focus:bg-black enabled:focus:ring-transparent dark:enabled:hover:bg-white dark:enabled:focus:bg-white dark:enabled:focus:ring-transparent'>{t("Submit")}</Button>
                        </div>
                    </form>
                </div>
            </div>
